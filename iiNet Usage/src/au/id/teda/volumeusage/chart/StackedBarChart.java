package au.id.teda.volumeusage.chart;
...
import au.id.teda.volumeusage.activity.UsageGraphActivity;
...
public class StackedBarChart extends ChartBuilder {
	...
	private XYMultipleSeriesDataset getMyData() {
		// Open Database
		DailyDataDBAdapter dailyDataDB = new DailyDataDBAdapter(context);
		dailyDataDB.open();
