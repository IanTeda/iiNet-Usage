...
import au.id.teda.volumeusage.R.id;
import au.id.teda.volumeusage.R.layout;

public final class SeekBarPreference extends DialogPreference implements OnSeekBarChangeListener {

    // Namespaces to read attributes
    private static final String PREFERENCE_NS = "http://schemas.android.com/apk/res/au.id.teda.volumeusage.prefs";
