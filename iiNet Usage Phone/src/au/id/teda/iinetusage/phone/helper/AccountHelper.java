...
public class AccountHelper extends AccountStatusHelper {
	...
	public AccountHelper(Context context) {
		context = myApplicationContext; // Set context for methods
	}
	
	// Check if all account information exists
	...
	public String getIPAddress(){
        ...
        if (statusExists()){
        	AccountStatusDBAdapter accountStatusDBAdapter = new AccountStatusDBAdapter(myApplicationContext);
